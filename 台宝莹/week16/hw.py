...
class DailogueSystem:
    ...
    def load(self):
        self.nodes_info = {}
        self.load_scenario(r"week16 对话系统\scenario\scenario-买衣服.json")
        # self.load_scenario(r"week16 对话系统\scenario\scenario-看电影.json")
        self.load_slot_template(r"week16 对话系统\scenario\slot_fitting_templet.xlsx")
    
    def load_scenario(self, scenario_file):
        with open(scenario_file, "r", encoding="utf-8") as f:
            self.scenario = json.load(f)
        scenario_name = scenario_file.split(".")[0] # week16 对话系统\scenario\scenario-买衣服
        scenario_name = scenario_name.split("\\")[-1] # scenario-买衣服
    ...
    #意图识别模块，对available_nodes中每个节点打分，选择分数最高的作为当前节点
