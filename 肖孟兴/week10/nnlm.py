...
class LanguageModel(nn.Module):
    def __init__(self, input_dim, vocab):
        ...
        self.pid_idx = self.layer.config.pad_token_id
    ...
    def forward(self, x, y=None):
        ...
        x,_ = self.layer(x,trg_mask)        #output shape:(batch_size, sen_len, input_dim)
...
def train(corpus_path, save_weight=True):
    ...
    vocab = build_vocab("week10/lstm语言模型生成文本/vocab.txt")       #建立字表
...
if __name__ == "__main__":
    ...
    train("week10/lstm语言模型生成文本/corpus.txt", False)
