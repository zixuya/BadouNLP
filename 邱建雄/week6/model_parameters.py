...
model = BertModel.from_pretrained(r"C:\Users\Administrator\Desktop\人工智能\week6 语言模型和预训练\bert-base-chinese", return_dict=False)
n = 2                       # 输入最大句子个数
vocab = 21128               # 词表数目
...
# embedding_size + embedding_sizes是layer_norm层参数--w+b归一化
...
# self_attention_out参数 其中 embedding_size * embedding_size + embedding_size + embedding_size是self输出的线性层参数，embedding_size + embedding_size是layer_norm层参数 归一化
...
# pool_fc层参数 Pooler 层对 [CLS] 标记的隐藏状态应用一个线性变换
