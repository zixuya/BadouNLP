...
class LanguageModel(nn.Module):
    def __init__(self):
        ...
        self.encoder = BertModel.from_pretrained(
            r"C:\Users\Administrator\Desktop\人工智能\week6 语言模型和预训练\bert-base-chinese", return_dict=False,
            attn_implementation='eager')
        self.classify = nn.Linear(self.encoder.config.hidden_size, self.encoder.config.vocab_size)
