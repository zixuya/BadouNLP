...
class LanguageModel(nn.Module):
    def __init__(self, hidden_size, vocab_size, pretrain_model_path):
        ...
        # self.layer = nn.LSTM(input_dim, input_dim, num_laquiyers=1, batch_first=True)
...
def build_model(vocab, char_dim, pretrain_model_path):
    model = LanguageModel(768, 12288, pretrain_model_path)
    return model
...
def train(corpus_path, save_weight=True):
    ...
    vocab_size = 12288  # 字表大小
    learning_rate = 0.001  # 学习率

    pretrain_model_path = r'../../week6 语言模型和预训练/bert-base-chinese'
