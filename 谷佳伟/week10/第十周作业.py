...
def train(corpus_path, save_weight=True):
    ...
    pretrain_model_path = r'D:\桌面\资料\\week6 语言模型和预训练\\bert-base-chinese'
    tokenizer = BertTokenizer.from_pretrained(pretrain_model_path) #分词器
...
if __name__ == "__main__":
    ...
    train(r"D:\桌面\资料\第十周 文本生成\\week10 文本生成问题\\lstm语言模型生成文本\\corpus.txt", False)
