...
class TorchModel(nn.Module):
    def __init__(self, input_dim,sq_len, vocab):
        ...
        self.classify = nn.Linear(input_dim, sq_len + 1)
...
def predict(model_path, vocab_path, input_strings):
    ...
    for i, input_string in enumerate(input_strings):
        print("输入：%s, 预测类别：%d" % (input_string, torch.argmax(result[i]))) #打印结果



if __name__ == "__main__":
    main()
    test_strings = ["fnvfe你", "wz你dfg", "r你wdeg", "n我kwww"]
