...
def train(corpus_path, save_weight=True):
    ...
    char_dim = 768        #每个字的维度
    window_size = 50       #样本文本长度，等于生成文本内容长度
    ...
    for epoch in range(epoch_num):
        ...
        print(generate_sentence("阿里巴巴2025财年第三财季净利润464.34亿元，同比大增333%", model, vocab, window_size))
        print(generate_sentence("2天市值暴涨50亿！机器人概念股紧急发声：从宇树科技仅赚1万元", model, vocab, window_size))
    if not save_weight:
        return
    else:
