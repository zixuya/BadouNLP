...
class DataGenerator:
    ...
    def random_train_sample(self):
        ...
        index_array = np.random.choice(standard_question_index,size=2,replace=False)
        if(len(self.knwb[index_array[0]])<2):
             return self.random_train_sample()
        a, p = random.sample(self.knwb[index_array[0]], 2)
        n = random.sample(self.knwb[index_array[1]], 1)
        return [a,p,n[0]]
