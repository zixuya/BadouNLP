...
def main():
    model = load_word2vec_model(r"C:\Users\Junmming\A01_File\AI_data\A05周\week5 词向量及文本向量\model.w2v") #加载词向量模型
    sentences = load_sentence(r"C:\Users\Junmming\A01_File\AI_data\A05周\week5 词向量及文本向量\titles.txt")  #加载所有标题
