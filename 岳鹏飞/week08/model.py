...
class SentenceEncoder(nn.Module):
    def __init__(self, config):
        ...
        # self.lstm = nn.LSTM(hidden_size, hidden_size, batch_first=True, bidirectional=True) #?加入bidirectional参数后，hidden_size维度会发生变化
...
class SiameseNetwork(nn.Module):
    def __init__(self, config):
        ...
        self.loss = nn.TripletMarginLoss() #选择triplet loss
...
if __name__ == "__main__":
    ...
    s3 = torch.LongTensor([[1,1,1,1], [2,1,2,1]])
