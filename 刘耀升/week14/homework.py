...
class BPETokenizer:
    ...
    def train(self, corpus, verbose=False):
        ...
        # 预处理文本
        ids_list = [self.preprocess(text) for text in corpus]
        ...
        for i in range(256, self.vocab_size):
            ...
            # 更新所有文本
            ids_list = [self.merge(ids, best_pair, i) for ids in ids_list]
    ...
    def encode(self, text):
        ...
        while len(ids) >= 2:
            ...
            ids = self.merge(ids, pair_to_merge, idx)
...
if __name__ == "__main__":
    ...
    print("解码文本:", tokenizer.decode([233,187,145]))
