...
def main(corpus_path, save_weight=True):
    ...
    pretrain_model_path = r'D:\BaiduNetdiskDownload\python学习资料\nlp深度学习\第六周 语言模型\bert-base-chinese'
    ...
    for epoch in range(epoch_num):
        ...
        print(generate_sentence("邓亚萍：互联网要有社会担当", model, tokenizer))
    if not save_weight:
        return
    else:
...
if __name__ == "__main__":
    main("E:\\study\\python study\\八斗\\周知识学习\\week10 文本生成问题\\transformers-生成文章标题\\sample_data.json", False)
