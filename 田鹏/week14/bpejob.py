...
if __name__ == "__main__":
    folder_path = r'E:\study\python study\八斗\周知识学习\week14 大语言模型相关第四讲\RAG\dota2英雄介绍-byRAG\Heroes'
    vocab_size = 1000
    ...
    print(encode("凡报名参加活动者，应根据自身状况进行运动"))
    print(decode(encode("凡报名参加活动者，应根据自身状况进行运动")))
