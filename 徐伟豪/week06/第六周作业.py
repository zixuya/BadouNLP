...
bert = BertModel.from_pretrained(r"D:\python\ev及资料\资料\week6\bert-base-chinese\bert-base-chinese", return_dict=False)
...
params_count = count_parameters(state_dict)
print(f"Bert中参数量总共有{params_count}")
