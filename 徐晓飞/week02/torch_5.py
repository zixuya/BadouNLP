...
class TorchModel(nn.Module):
    def __init__(self, input_size):
        ...
        self.linear = nn.Linear(input_size, out_features=5, bias=True)  # 线性层
        # self.linear2 = nn.Linear(5, out_features=1, bias=True)
        # self.activation = torch.softmax(dim=5)  # softmax
