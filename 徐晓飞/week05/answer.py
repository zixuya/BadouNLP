...
result, centers, _ = kmeans.cluster()

for index in range(len(result)):
    cla = result[index]
    center = centers[index]
    cla.sort(key=lambda per_vector: nn.functional.pairwise_distance(torch.tensor(per_vector), torch.tensor(center)).data.item(), reverse=True)
