...
class LanguageModel(nn.Module):
    def __init__(self, vocab):
        ...
        self.bert = BertModel.from_pretrained(r"E:\AI\第六周 语言模型\bert-base-chinese", return_dict=False)
    ...
    def forward(self, x, y=None):
        ...
        x, _ = self.bert(x, attention_mask=causal_mask)          #output shape:(batch_size, sen_len, hidden_size)
