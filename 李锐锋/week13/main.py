...
from model import choose_optimizer, BertModelNER
...
def main(config):
    ...
    lora_config = LoraConfig(task_type=TaskType.TOKEN_CLS, r=4, lora_alpha=8, inference_mode=False, lora_dropout=0.1,
