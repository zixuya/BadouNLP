...
class DialogueSystem():
    ...
    def load(self):
        self.nodes_info = {}
        scenario_path1 = "scenario-买衣服.json"
        scenario_path2 = "scenario-看电影.json"
        slot_template__path = "slot_fitting_templet.xlsx"
        self.load_scenario(scenario_path1)
        self.load_scenario(scenario_path2)
        self.load_slot_template(slot_template__path)
    ...
    def load_slot_template(self, slot_template__path):
        ...
        # self.slot_template = pd.read_excel(slot_template__path)
        # #slot	query	values
        # self.slot_to_qv = {}
