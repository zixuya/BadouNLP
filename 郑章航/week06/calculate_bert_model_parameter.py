...
bert = BertModel.from_pretrained(r"D:\models\bert-base-chinese", return_dict=False)
#加载配置
config = bert.config
# print("bert-base-chinese的config：")
# print(config)
...
class DiyBert:
    ...
    def __init__(self, state_dict):
        ...
        self.num_layers = config.num_hidden_layers        #注意这里的层数要跟预训练config.json文件中的模型层数一致
