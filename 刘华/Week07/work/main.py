...
if __name__ == "__main__":
    ...
    print(train_result, 'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr')
    # 将结果输出为 csv
    column_aliases = ['模型', '学习率', '句子最大长度', 'bert层数', '训练轮数', '池化规则', '正确率']
    df = pd.DataFrame(train_result, columns=['model_type', 'learning_rate', 'max_length', 'num_layers', 'epoch', 'pooling_style', 'acc'])
