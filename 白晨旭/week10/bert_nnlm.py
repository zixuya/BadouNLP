...
def train(corpus_path, save_weight=True):
    ...
    pretrain_model_path = r'C:\Users\chenxubai\Downloads\八斗\week6 语言模型和预训练\bert-base-chinese'
...
if __name__ == "__main__":
    ...
    train(r"C:\Users\chenxubai\Downloads\八斗\week10 文本生成问题\lstm语言模型生成文本\corpus.txt", False)
