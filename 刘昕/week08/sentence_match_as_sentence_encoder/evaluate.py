...
from 其他.CNNforward import hidden_size
...
class Evaluator:
    ...
    def knwb_to_vector(self):
        ...
        with torch.no_grad():
            ...
            self.knwb_vectors = self.model(question_matrixs) #(question_num, max_len) -> (question_num, hidden_size)
            #将所有向量都作归一化 v / |v|
    ...
    def eval(self, epoch):
        ...
        for index, batch_data in enumerate(self.valid_data):
            ...
            with torch.no_grad():
                # batch_size, max_len -> batch_size, hidden_size
    ...
    def write_stats(self, test_question_vectors, labels):
        ...
        for test_question_vector, label in zip(test_question_vectors, labels):
            ...
            #test_question_vector shape [hidden_size]   knwb_vectors shape = [n, hidden_size]
