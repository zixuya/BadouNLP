...
class LanguageModel(nn.Module):
    def __init__(self, input_dim, vocab):
        ...
        self.bert = BertModel.from_pretrained(r'F:\AI学习\第六周 语言模型\bert-base-chinese')  # 加载中文BERT模型
...
def train(corpus_path, save_weight=True):
    ...
    tokenizer = BertTokenizer.from_pretrained(r'F:\AI学习\第六周 语言模型\bert-base-chinese')
